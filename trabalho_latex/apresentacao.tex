...
\begin{frame}{Metodologia --- geração assistida das simulações}
  \begin{itemize}
    ...
    \item \texttt{run\_all\_simulations.sh}: varredura uniparamétrica
          (um eixo por vez) sobre todo o espaço de hardware.
    \item L2, memória, núcleos e hierarquia não impactavam o desempenho
          com $n=6$ (vetor cabia todo na L1) $\rightarrow$ motivou o
          benchmark de $n=100.000$.
    \item \texttt{search\_simulations.py}: busca em grade/aleatória
          adicional sobre o espaço de hardware.
  \end{itemize}
\end{frame}
